...
NH_SYS, RB_SYS, HM_SYS = extract_values(marker, sys)
print(len(NH_SYS),len(RB_SYS),len(HM_SYS))
#plt.savefig("./"+dirname+"/save.png")
plt.plot(NH_SYS,label="nohint")
plt.plot(RB_SYS,label="robot")
plt.plot(HM_SYS,label="human")
plt.xlabel("timestamp[sec]")
plt.ylabel("value (sys)")
plt.legend()

plt.subplot(GRAPH_VER,GRAPH_HOR,GRAPH_CO)
NH_CO, RB_CO, HM_CO = extract_values(marker, co)
print(len(NH_CO),len(RB_CO),len(HM_CO))
#plt.savefig("./"+dirname+"/save.png")
plt.plot(NH_CO,label="nohint")
plt.plot(RB_CO,label="robot")
plt.plot(HM_CO,label="human")
plt.xlabel("timestamp[sec]")
plt.ylabel("value (co)")
plt.legend()

plt.subplot(GRAPH_VER,GRAPH_HOR,GRAPH_SVR)
NH_SVR, RB_SVR, HM_SVR = extract_values(marker, svr)
print(len(NH_SVR),len(RB_SVR),len(HM_SVR))
#plt.savefig("./"+dirname+"/save.png")
plt.plot(NH_SVR,label="nohint")
plt.plot(RB_SVR,label="robot")
plt.plot(HM_SVR,label="human")
plt.xlabel("timestamp[sec]")
