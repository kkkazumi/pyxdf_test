...
plt.plot(tNH_SYS,NH_SYS,label="nohint",linestyle=":")
plt.plot(tRB_SYS,RB_SYS,label="robot",linestyle="-.")
...
#plt.savefig("./"+dirname+"/save.png")
plt.plot(tNH_CO,NH_CO,label="nohint",linestyle=":")
plt.plot(tRB_CO,RB_CO,label="robot",linestyle="-.")
...
#plt.savefig("./"+dirname+"/save.png")
plt.plot(tNH_SVR,NH_SVR,label="nohint",linestyle=":")
plt.plot(tRB_SVR,RB_SVR,label="robot",linestyle="-.")
