...
plt.plot(rotated_NH[0],rotated_NH[1],label="nohint",linestyle=":")
plt.plot(rotated_RB[0],rotated_RB[1],label="robot",linestyle="-.")
plt.plot(rotated_HM[0],rotated_HM[1],label="human")

plt.scatter(rotated_NH[0],rotated_NH[1],
    c=np.array(tNH_CO),
    cmap=cm.Blues,
    marker='o',
...
plt.scatter(rotated_RB[0],rotated_RB[1],
    c=np.array(tRB_CO),
    cmap=cm.Reds,
    marker='s',
...
plt.scatter(rotated_HM[0],rotated_HM[1],
    c=np.array(tHM_CO),
    cmap=cm.Greens,
    marker='v',
    label="human")
...
cNHx,cNHy=calculate_centroid(rotated_NH[0],rotated_NH[1])
print("cNH",cNHx,cNHy)
plt.scatter(cNHx,cNHy,marker='o',color="blue",facecolor="white")
cRBx,cRBy=calculate_centroid(rotated_RB[0],rotated_RB[1])
print("cRB",cRBx,cRBy)
plt.scatter(cRBx,cRBy,marker='s',color="red",facecolor="white")
cHMx,cHMy=calculate_centroid(rotated_HM[0],rotated_HM[1])
print("cHM",cHMx,cHMy)
plt.scatter(cHMx,cHMy,marker='v',color="green",facecolor="white")
...
plt.savefig("./"+dirname+"/"+dirname+"_scatter_MAP.png")
