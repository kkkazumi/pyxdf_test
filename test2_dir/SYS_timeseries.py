...
plt.plot(tNH_SVR,NH_SYS_r/sys_baseline,label="nohint",linestyle=":")
plt.plot(tRB_SVR,RB_SYS_r/sys_baseline,label="robot",linestyle="-.")
plt.plot(tHM_SVR,HM_SYS_r/sys_baseline,label="human")
...
#plt.savefig("./"+dirname+"/"+dirname+"_SYS_timeseries.png")
plt.savefig("./"+dirname+"/"+dirname+"_SYS_timeseries.eps")
